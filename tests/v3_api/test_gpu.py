...
DISABLE_GPU_CLUSTER = os.environ.get('RANCHER_DISABLE_GPU_CLUSTER', "")
K3S_CLUSTER = os.environ.get('RANCHER_K3S_CLUSTER', "")
K8S_CLUSTER = os.environ.get('RANCHER_K8S_CLUSTER', "")
...
if_k8s_cluster =  pytest.mark.skipif(not K8S_CLUSTER, reason='k8s test case')
